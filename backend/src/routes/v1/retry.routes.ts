 ...
 */
router.post('/document/:documentId', requireAuth, async (req: AuthRequest, res: Response) => {
  try {
 ...
 */
router.post('/document/:documentId/save-as-draft', requireAuth, async (req: AuthRequest, res: Response) => {
  try {
    const userId = req.user?.id;
    if (!userId) {
      return res.status(401).json({
 ...
 */
router.post('/reset-circuit-breaker', requireAuth, async (req: AuthRequest, res: Response) => {
  try {
